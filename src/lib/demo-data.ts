...
export const CURRENT_OFFICER = "Sarah Lin";
...
function driversFor(c: {
  ...
  if (c.value >= 500) {
    out.push({
      ...
      detail: `Order value is $${c.value.toFixed(2)}. Autonomous refunds are hard-capped at $500.00 under Policy Rule PR-GOV-901.`,
      tag: "HARD GATE",
      tone: "negative",
    });
  }
...
const SEEDS: Seed[] = [
  {
    ...
    tier: "Tier 2 Loyalty",
    region: "US-West",
    product: "Arc'teryx Alpha SV Shell Jacket",
    category: "Outerwear / GoreTex",
    sku: "ARC-MN-6641-BLK-L",
    value: 799,
    mlScore: 0.714,
  ...
  },
  {
    ...
    tier: "Tier 1",
    region: "EU-Central",
    product: "Zara Satin Cocktail Dress",
    category: "Formalwear",
    sku: "ZRA-DRS-8871-NVY",
    value: 189,
    mlScore: 0.312,
  ...
  },
  {
    ...
    customer: "Hannah Weiss",
    customerId: "USR-49220",
    tier: "Tier 1",
    region: "EU-Central",
    product: "Patagonia Nano Puff",
    category: "Outerwear",
    sku: "PTG-NNP-MED-GRN",
    value: 239,
    mlScore: 0.888,
  ...
  },
  {
    ...
    customer: "Peter Salter",
    customerId: "USR-19845",
    tier: "Tier 1",
    region: "US-East",
    product: "Weber Genesis E-325s",
    category: "Outdoor",
    sku: "WBR-GEN-E325",
    value: 1099,
    mlScore: 0.83,
  ...
  },
  {
    ...
    customer: "Mia Hollande",
    customerId: "USR-84420",
    tier: "VIP Diamond",
    region: "EU-West",
    product: "Chanel Classic Flap Wallet",
    category: "Luxury / Accessories",
    sku: "CHN-CFW-BLK",
    value: 1550,
    mlScore: 0.77,
  ...
  },
  {
    ...
    tier: "Tier 1",
    region: "US-East",
    product: "Theory Wool Blazer",
    category: "Formalwear",
    sku: "THY-BLZ-4402-CHR",
    value: 545,
    mlScore: 0.291,
    riskClass: "wardrobing",
    evidenceState: "conflict",
    ...
    members: [
      {
        ...
        detail: "iPhone 15 Pro • Canvas 0x8F9A",
      },
      {
        name: "Jess Miller",
        userId: "USR-90482",
        signal: "Shared Address",
        detail: "Apt 4B, Warehouse District",
      },
      {
        name: "J.M. Apparel",
        userId: "USR-90551",
        signal: "Shared Payment",
        detail: "Stripe Virtual #4128 (BIN 412800)",
      },
    ],
    sharedAttributes: [
...
export const DEMO_AUDIT: AuditEntry[] = [
  {
    ...
    target: "CASE-89241",
    detail: "Case routed to lead reviewer under the $500 value gate.",
  },
  {
    id: "AUD-4400",
