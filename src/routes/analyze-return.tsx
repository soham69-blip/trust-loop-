...
const PRESETS: Record<string, Partial<AnalyzeInput>> = {
  "Clean defect claim": {
    customer: "Meera Iyer",
    product: "Wildcraft Hypadry Pro Jacket",
    category: "Outerwear",
    sku: "WLC-HYD-3312-BLU",
    value: 23400,
  ...
  "Wardrobing pattern": {
    customer: "Ishita Rao",
    product: "Sabyasachi-style Silk Lehenga",
    category: "Formalwear",
    sku: "SLK-LEH-7781-EMR",
    value: 35900,
    claim: "Didn't suit me, returning unworn after the weekend.",
    daysSinceDelivery: 3,
    returnRate: 0.64,
    lifetimeValue: 159000,
    accountAgeYrs: 2.2,
    photosAttached: true,
    tagsIntact: false,
  ...
  "Known fraud ring": {
    customer: "S.M. Apparels (Surat)",
    product: "Designer Tote — Premium Label",
